...
router.post("/insert", function (req, res, next) {
  colModel.insertColaborador(req.body, function (err, result) {
    if (err) res.json({ response: "Error", msg: err });
    console.log("res", result);
    res.json({
      response: result,
...
router.put("/update", function (req, res, next) {
  colModel.updateColaborador(req.body, function (err, result) {
    if (err) res.json({ response: "Error", msg: err });
    console.log("res", result);
    res.json({
      response: result,
...
router.put("/delete/:id", function (req, res, next) {
  colModel.deleteColaborador(req.params.id, function (err, result) {
    if (err) res.json({ response: "Error", msg: err });
    console.log("res", result);
    res.json({
      response: result,
